...
datagroup: mtr_isidro_24_2_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: mtr_isidro_24_2_default_datagroup
...
# To see the Explore you’re building, navigate to the Explore menu and select an Explore under "Mtr Isidro 24 2"
